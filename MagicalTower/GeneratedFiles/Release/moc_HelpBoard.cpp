/****************************************************************************
** Meta object code from reading C++ file 'HelpBoard.h'
**
...
#include <memory>
#include "../../View/HelpBoard.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'HelpBoard.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject HelpBoard::staticMetaObject = { {
    ...
    qt_meta_stringdata_HelpBoard.data,
    qt_meta_data_HelpBoard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
